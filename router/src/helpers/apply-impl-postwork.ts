...
): Promise<{ nextLabel: 'shopfloor:needs-review' | 'shopfloor:impl-in-review'; skipReason?: string }> {
...
export async function runApplyImplPostwork(adapter: GitHubAdapter): Promise<void> {
